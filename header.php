					...
					<nav class="header_nav -wide visible-md-block visible-lg-block">
						<div class="header_nav--inner">
							<ul class="menu">
								...
								<li class="menu-item"><a href="careers.php">Careers<span class="menu-item-notify">3 jobs</span></a></li>
								...
								<div class="col-lg-2 col-md-12">
									<div class="header--logo logo">
										<a href="#"><!-- <img src="assets\images\design\logo-header.png" alt="" style="width:150px;"> -->
											<span style="font-size: 20px;"> RecapitaFinance </span>
					...
					<nav class="header_nav -wide visible-md-block visible-lg-block">
						<div class="header_nav--inner">
							<ul class="menu">
								...
								<li class="menu-item menu-item-has-mega-menu">
									<a href="case-studies.htm">Case Study</a>
